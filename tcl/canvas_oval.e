class CANVAS_OVAL 
	-- Represents an oval item on a canvas.
	-- @@ This and CANVAS_RECT should inherit from a common base class
	-- @@ than handles dealing with the bounding box, outline width, fill
	-- @@ color, etc.
